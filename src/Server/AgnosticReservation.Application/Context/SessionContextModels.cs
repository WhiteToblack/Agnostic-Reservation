...
public record SessionUserInfo(Guid Id, string Email, string FullName, string PreferredTheme, string Role, int HierarchyLevel, bool IsSuperAdmin, IReadOnlyCollection<Permission> Permissions);
